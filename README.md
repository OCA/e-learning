...
--- | --- | --- | ---
[website_sale_slides_order_line_link](website_sale_slides_order_line_link/) | 17.0.1.0.3 |  | Link sales order lines to slide channel participations in sold courses.
